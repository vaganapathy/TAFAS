...
class Model(nn.Module):
    ...
    '''
    def __init__(self, configs, configs_all, dynamic_dim=128, hidden_dim=64, hidden_layers=2, num_blocks=3, multistep=False):
        """
    ...
    def _get_mask_spectrum(self, configs):
        ...
        """
        train_loader = construct_loader(self.configs_all, 'train')
        amps = 0.0
